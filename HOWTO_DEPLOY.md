...
* usp-aero/platform - The Aero platform website
* usp-aero/waap - The Aero WAAP website
...
* platform - builds the site into GIT branch "gh-pages", in a version-specific subdirectory (using the "mike" mkdocs extension)
* waap - same as platform
...
Changes in a sub-site like "platform" require to run the "release.sh" script in that subfolder, with the required parameters, e.g.
