...
![Image Test](assets/images-wizard/screenshot_aero_wizard_welcome.png)

![Image Test2](../assets/images-wizard/screenshot_aero_wizard_welcome.png)
...
* Ease-of-use: The platform allows an easy setup and regular (automated) updates to ensure a low cost of operations but 
  also ensures to keep up to date with software components and allows to fix vulnerabilities in an efficient and timely manner.
...
* Versatility and extensibility: The Aero platform can be seamlessly extended with several component (WAAP reverse proxy,
  WAAP Authenticate, ***TODO*** ) and future component that will provide new functionality.