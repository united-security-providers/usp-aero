...
serves. If you instead want the client to be sent to a different URL, use [Redirect requests](redirect).
...
6. [Create a revision and deploy it](../../../platform/1.0.x/concepts/configuration-lifecycle) to
apply the change.
