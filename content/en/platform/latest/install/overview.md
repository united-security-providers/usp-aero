...
2. Bootstraping the USP Aero base OS.
...
3. First-time Setup Wizard
    ...
    is started for the first-time configuration of the system. It allows to finalize networking configuration,
